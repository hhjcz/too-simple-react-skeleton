  ...
  render() {
    ...
    return (
      <div>
        ...
        <PotencialniUmisteni lokalitaHint={lokalitaHint} seznamUmisteni={seznamUmisteni.toArray ? seznamUmisteni.toArray() : seznamUmisteni} umistiZarizeni={self.umistitZarizeni} deleteAllUmisteni={self.deleteAllUmisteni} />
      </div>
    )
  }
}
